            ...
            window.addEventListener("message", (event) => {
                ...
                switch (data.action) {
                    case "ui":
                        ...
                        this.playerName = data.playerName || "Oyuncu";
                    ...
                    case "setupCharacters":
                        ...
                        // Karakter ekranı açılınca ilk mevcut karakteri otomatik preview et
                        ...
                        if (firstCharIndex !== -1) {
                            this.selectedCharacter = firstCharIndex;
                            axios.post("https://qb-multicharacter/cDataPed", {
                                cData: this.characters[firstCharIndex],
                            });
                        } else {
                            axios.post("https://qb-multicharacter/cDataPed", {});
                        }
